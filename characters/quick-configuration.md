...
{% hint style="info" %}
You can add any graphics or components to this character to make it work for your game. There are also exposed variables on existing components. Some common changes would be to the [CharacterMovementSettings](character-movement-system/character-movement-data.md) component or adding graphics to the NetworkedGraphicsHolder.
{% endhint %}
